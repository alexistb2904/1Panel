...
func TestDeveloperHasScopedLifecycleWithoutHostPrimitives(t *testing.T) {
	...
	mustHave(t, role,
		"website.create", "website.delete", "website.ssl.view",
...
func TestSecurityAdvisorIsNonDestructiveAndNoSecretCapabilities(t *testing.T) {
	...
	mustNotHave(t, role,
		...
		"website.files.read", "website.files.write", "website.files.delete",
		"database.query.write", "docker.container.exec",
...
func TestUserAndVisitorSeparation(t *testing.T) {
	...
	mustHave(t, user, "website.view", "website.logs.view", "website.runtime.view", "website.ssl.view")
	mustNotHave(t, user,
		"website.files.read", "website.files.write", "website.files.delete",
		"website.create", "website.update", "website.delete",
		"website.backup.create", "website.shell", "website.ssl.manage")
	mustHave(t, visitor, "website.view", "website.runtime.view")
	mustNotHave(t, visitor,
		"website.files.read", "website.files.write", "website.files.delete",
		"website.logs.view", "website.backup.create", "website.ssl.view")
}
